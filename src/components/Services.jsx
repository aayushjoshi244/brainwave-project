    ...
    <Section id="how-to-use">
      <div className="container">
        ...
        <div className="relative">
          ...
          <div className="relative z1 grid gap-5 lg:grid-cols-2">
            <div className="relative min-h-[39rem] border border-n-1/10 rounded-3xl overflow-hidden">
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-8 bg-gradient-to-b from-n-8/0 to-n8/90 lg:p-15">
